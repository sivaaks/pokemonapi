...
(function(){
    ...
    displayOption.innerText='Display : ';

    const dispGrid= document.createElement('button');
    dispGrid.setAttribute('class','btn-toogle');
    dispGrid.setAttribute('onclick','toggleView(true)');
    dispGrid.innerText='Grid';

    const dispList= document.createElement('button');
    dispList.setAttribute('class','btn-toogle');
    dispList.setAttribute('onclick','toggleView(false)');
    dispList.innerText='List';

    displayOption.append(dispGrid,dispList);

    const inputOptions= document.createElement('div');
    inputOptions.setAttribute('class','input-container');

    const inputNumber= document.createElement('input');
    inputNumber.setAttribute('class','input-text');
    inputNumber.placeholder= 'Enter the number of pokemons';
    inputNumber.innerText='60';
    ...
    inputOptions.append(inputNumber,refreshButton);

    options.append(displayOption,inputOptions);
...
function toggleView(grid){
    ...
    if(grid===true){
        ...
        pokemonContainer.style.width='450px';
    }
    if(grid===false){
        container.style.flexDirection='column';
        container.style.alignItems='stretch';
        pokemonContainer.style.width='800px';
    }

}

let numberOfPokemons= 120;
...
function displayPokemons(pokemonDetails) {
    ...
    pokemonMoves.innerHTML+= '<button class= "more-moves-btn" onclick="toggleMoreMoves(true)">More..</button>'
...
function toggleMoreMoves(moves){

    const buttonMoreMoves= document.querySelector('.more-moves');
    const buttonMoreText= document.querySelector('.more-moves-btn').innerText;

    console.log(buttonMoreText);

    if(buttonMoreText=='More..') {
        buttonMoreMoves.classList.toggle('more-moves');
        buttonMoreText.innerText='Less..';
    } if(buttonMoreText=='Less..'){
        buttonMoreMoves.classList.toggle('more-moves');
        buttonMoreText.innerText='Less..';
    }
    ...
    // const popUpMoreMoves= document.createElement('span');
    // popUpMoreMoves.setAttribute('class','popup-text');
    // popUpMoreMoves.setAttribute('class','move-tag');
    // popUpMoreMoves.innerText=moves;
    //pokemonMoves.append(popUpMoreMoves);
    
   // buttonMoreMoves.append(popUpMoreMoves);
